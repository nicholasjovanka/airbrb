      ...
      <Box sx = {{ boxShadow: 3, my: 1, px: 2, py: 1 }}>
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12}>
            <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
              ...
              <Button component='label' variant='contained' startIcon={<CloudUploadIcon />}>
                Upload file
                <VisuallyHiddenInput type='file' onChange={(e) => { handleFileInput('thumbnail', e) }} />
              </Button>
            </Box>
            <ImageCard key='thumbnailImage' image={formFields.thumbnail} sx={{ my: 1 }}/>
          </Grid>
          <Grid item xs={12}>
            <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
              <Typography variant='subtitle1'>
              ...
              <Button component='label' variant='contained' startIcon={<CloudUploadIcon />} aria-describedby='hosting-images-description'>
                Upload file
                <VisuallyHiddenInput type='file' multiple onChange={(e) => { handleFileInput('files', e) }}/>
              </Button>
          ...
          <Grid item xs={12} sx={{ mb: 2 }}>
            <Button component='label' variant='contained' onClick={(e) => { console.log(formFields) }}>
              Create Listing
            </Button>
          </Grid>
        </Grid>
      </Box>
      <MessageModal header='Error' content={modalMessage} open={openModal} setOpen={setOpenModal}></MessageModal>
  </Container>
  )
}
